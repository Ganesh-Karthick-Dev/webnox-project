          ...
          image.map((val) => {
            return (
                ...
                <img
                  ...
                  alt=""
                />
                <button className="absolute m-2 top-0 right-0 rounded-md p-2 bg-red-500 text-white opacity-0 hover:opacity-100 transition duration-300" onClick={()=>handleDelImg(val)}>
